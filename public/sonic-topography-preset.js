...
(function (global) {
  ...
  var SONIC_THEME_GROUND_PALETTE = {
    'nocturnal':        { base: '#05070c', cool: '#6c5ce7', warm: '#a29bfe', accent: '#dfe6fd' },
    'ocean-deep':       { base: '#05070c', cool: '#0984e3', warm: '#74b9ff', accent: '#dfe6fd' },
    'arctic-aurora':    { base: '#05070c', cool: '#00cec9', warm: '#81ecec', accent: '#dfe6fd' },
    'cyber-forest':    { base: '#05070c', cool: '#00b894', warm: '#55efc4', accent: '#dfe6fd' },
    'golden-hour':      { base: '#05070c', cool: '#fdcb6e', warm: '#ffeaa7', accent: '#ffffff' },
    'ember-fire':      { base: '#05070c', cool: '#e17055', warm: '#fab1a0', accent: '#fdcb6e' },
    'crimson-sunset':  { base: '#05070c', cool: '#e74c3c', warm: '#ff7675', accent: '#fdcb6e' },
    'coral-mirage':    { base: '#05070c', cool: '#fd79a8', warm: '#fab1a0', accent: '#fdcb6e' },
    'neon-tokyo':      { base: '#05070c', cool: '#a29bfe', warm: '#fd79a8', accent: '#fdcb6e' },
    'minimal-monochrome': { base: '#05070c', cool: '#dfe6e9', warm: '#b2bec3', accent: '#ffffff' }
  };

  function sonicThemeGroundTheme(fx) {
    var name = fx && fx.sonicTheme ? String(fx.sonicTheme) : 'cycle';
    var pal = SONIC_THEME_GROUND_PALETTE[name] || null;
    if (!pal) return sonicCoverGroundTheme(fx);
    var tint = new THREE.Color((fx && fx.visualTintColor) || '#62d6ff');
    var base1 = new THREE.Color(pal.base);
    return {
      base1: base1,
      base2: base1.clone().lerp(new THREE.Color('#ffffff'), 0.12),
      coolCore: new THREE.Color(pal.cool).lerp(tint, fx && fx.visualTintMode === 'custom' ? 0.08 : 0.0),
      warmCore: new THREE.Color(pal.warm).lerp(tint, fx && fx.visualTintMode === 'custom' ? 0.05 : 0.0),
      ripple: new THREE.Color(pal.accent)
    };
  }
  ...
  function syncTheme(mat, fx, audio, dt) {
    ...
    var theme = sonicUsesCustomGroundColors(fx)
      ...
      : (fx && fx.sonicTheme && fx.sonicTheme !== 'cycle' ? sonicThemeGroundTheme(fx) : sonicCoverGroundTheme(fx));
