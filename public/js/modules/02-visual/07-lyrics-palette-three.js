...
/** legacy mesh 布局偏移 — 必须常驻（row-layers 栈不加载旧 10） */
...
function lyricMeshRoleOffsets(role) {
  ...
  var curScale = typeof isLyricCinemaMode === 'function' && isLyricCinemaMode() ? 1.18 : 0.96;
  var curY = typeof isLyricCinemaMode === 'function' && isLyricCinemaMode() ? 0.12 : 0.30;
