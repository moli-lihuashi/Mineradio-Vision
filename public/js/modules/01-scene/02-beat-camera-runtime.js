function flushPersistentVisualState() {
  ...
  try { saveSleepTimerState(); } catch (e) {}
}
...
function resetCinemaTrackProfile(song) {
  ...
  if (Mineradio.moodAudio && Mineradio.moodAudio.resetTrackAnalysis) Mineradio.moodAudio.resetTrackAnalysis();
...
function applyCinemaProfileFromBeatMap(map) {
  ...
  if (Mineradio.moodAudio && Mineradio.moodAudio.setBeatMapHint) Mineradio.moodAudio.setBeatMapHint(map);
...
function scheduleBeatCamera(beat, source) {
  ...
  if (Mineradio.moodAudio && Mineradio.moodAudio.getBeatCameraAmpMul) {
    amp *= Mineradio.moodAudio.getBeatCameraAmpMul();
  }
  var attack = dj
