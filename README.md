...
在原项目当前版本 v2.1.0 的歌词舞台、粒子视觉、3D 歌单架、电影镜头、完整桌面模式与多平台接入基础上，本版本进行了大规模架构重构与功能扩展：QQ Cookie 自动续期、酷狗 KRC 歌词解密、LiquidGlass 液态玻璃视觉系统，Sonic Topography 音域回响预设，桌面歌词，天气雨滴，原生 C++ BPM 分析等。
